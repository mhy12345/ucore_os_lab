...
alloc_proc(void) {
	 ...
	 */
     ...
     //LAB6 2016011275 : (update LAB5 steps)
    /*
    ...
    //LAB8:EXERCISE2 2016011275 HINT:need add some code to init fs in proc_struct, ...
        proc->filesp = NULL;
    }
    return proc;
}
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    ret = -E_NO_MEM;
    //LAB4:EXERCISE2 2016011275
    //LAB8:EXERCISE2 2016011275  HINT:how to copy the fs in parent's proc_struct?
    /*
	...
	//    LAB5: update step 5: insert proc_struct into hash_list && proc_list, set the relation links of process
    bool intr_flag;
    local_intr_save(intr_flag);
    {
        proc->pid = get_pid();
	...
	//LAB5 2016011275: (update LAB4 steps)
   /* Some Functions
...
load_icode(int fd, int argc, char **kargv) {
    /* LAB8:EXERCISE2 2016011275 HINT:how to load the file with handler fd  in to process's memory? how to setup argc/argv?
     * MACROs or Functions:
